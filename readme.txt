...
Tags: disable, block, admin, ajax, frontend
...
* [Plugin GitHub](https://github.com/littlebizzy/disable-admin-ajax)
...
* [WordPress Codex](https://codex.wordpress.org/AJAX_in_Plugins)
* [Mike N Garrett](https://gist.github.com/MikeNGarrett/cb67142e1359168b67d6b5abab8110b1)
* [Delicious Brains](https://deliciousbrains.com/comparing-wordpress-rest-api-performance-admin-ajax-php/)
* [Stack Exchange #190993](https://wordpress.stackexchange.com/questions/190993/why-use-admin-ajax-php-and-how-does-it-work)
* [Stack Exchange #77407](https://wordpress.stackexchange.com/questions/77407/how-does-admin-ajax-php-work)
* [Stack Exchange #28702](https://wordpress.stackexchange.com/questions/28702/blocking-the-admin-section-but-still-using-admin-ajax-php)
* [Pangolin](https://gopangolin.com/beyond-admin-ajax-using-wordpress-rest-api/)
...
1. Upload the plugin files to `/wp-content/plugins/disable-admin-ajax-littlebizzy`
2. Activate via WP Admin > Plugins
3. Check frontend pages cannot access `admin-ajax.php`
